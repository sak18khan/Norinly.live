      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row justify-between gap-16 mb-24">
          <div className="space-y-8 max-w-sm text-center lg:text-left">
            ...
            <p className="text-secondary-text font-bold leading-relaxed text-[11px] uppercase tracking-widest opacity-70">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-12 md:gap-16 lg:gap-24">
            <div className="space-y-6">
              <h4 className="text-[9px] font-black text-secondary-text uppercase tracking-widest opacity-40">Platform</h4>
            ...
            <div className="space-y-6">
              <h4 className="text-[9px] font-black text-secondary-text uppercase tracking-widest opacity-40">Resources</h4>
              <ul className="space-y-4">
            ...
            <div className="space-y-6 col-span-2 md:col-span-1">
              <h4 className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.3em] opacity-40">Quick Links</h4>
              <ul className="grid grid-cols-1 gap-3">
                <li><Link href="/practice-english-speaking" className="text-[10px] font-black text-zinc-400 hover:text-black transition-colors uppercase tracking-[0.15em] leading-loose">Practice English Speaking</Link></li>
                <li><Link href="/talk-to-english-speakers" className="text-[10px] font-black text-zinc-400 hover:text-black transition-colors uppercase tracking-[0.15em] leading-loose">Talk to English Speakers</Link></li>
                <li><Link href="/free-english-speaking-practice" className="text-[10px] font-black text-zinc-400 hover:text-black transition-colors uppercase tracking-[0.15em] leading-loose">Free English Practice</Link></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-12 border-t border-border gap-8">
          <p className="text-[9px] font-black text-secondary-text uppercase tracking-widest opacity-40">
            © {new Date().getFullYear()} Norinly. <span className="hidden sm:inline">All rights reserved.</span>
          </p>
          <div className="flex items-center gap-2 text-[9px] font-black text-secondary-text uppercase tracking-widest group cursor-default opacity-40">
